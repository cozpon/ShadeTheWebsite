...
Your continued use of the Shadee App following the posting of changes will mean that you accept and agree
to the changes.
As long as you comply with these Terms of Use, Backyard Boiz grants you a personal, non-exclusive, non-transferable,
limited privilege to enter and use the Shadee App.
...
We are a morally green company, the Shadee App therein and accepted to by the United States Application Computer Science Committee ("USACSC")
accepts no responsibility or legal recourse to the user's content or content submitted by users of the Shadee App.
<br/>
The Backyard Boiz created the Shadee App as a tool, what the user's use of the Shadee App is entirely to their discretion and does not reflect the views or intentions of the Backyard Boiz llc.<br/>
